...
import {signUp, validateEmail, validateUsername} from '../../utils/APIRequests/AuthRequests.jsx';
...
const SignupForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setIsLoading(true);
    signUp({name, username, email, password}, signupCallback, signupErrorCallback);
  };
  ...
  return(
    <div className={styles.Form}>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <p className={styles.errorMessage}>{isUsernameError && usernameErrorMessage}</p>
        ...
        <p className={styles.errorMessage}>{isEmailError && emailErrorMessage}</p>
        ...
        <p className={styles.errorMessage}>{isPasswordError && passwordErrorMessage}</p>
