...
export const validateUsername = (username, callback) => {
  axios
    .get(`${BASE_URL}/auth/isExistByUsername/${username}`)
    .then((res) => callback(res.data));
};

export const validateEmail = (email, callback) => {
  axios
    .get(`${BASE_URL}/auth/isExistByEmail/${email}`)
    .then((res) => callback(res.data));
};

export const confirmEmail = (token, callback) => {
  axios
    .post(`${BASE_URL}/auth/confirm/${token}`)
    .then((res) => callback(res.data))
